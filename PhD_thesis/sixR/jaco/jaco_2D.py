...
class MakeTitle(Scene):
    def construct(self):
        ...
        affiliations = Tex(r"$^1$ Laboratoire des Sciences du Numerique de Nantes, France").next_to(authors,
                                                                                                    DOWN).scale(0.45)
        icra_L = ImageMobject("../../../Jaco/pics/icra23_logo.png").scale(0.8).move_to([-2, 2.5, 0])
        ls2n = ImageMobject("../../../Jaco/pics/ls2n_logo.png").scale(0.2).move_to([2, 2.5, 0])
        ...
        ls2n2 = ImageMobject("../../../Jaco/pics/ls2n_logo.png").scale(0.1).move_to([6, 3.5, 0])
